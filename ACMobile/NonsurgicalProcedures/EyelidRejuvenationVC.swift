//
//  EyelidRejuvenationVC.swift
//  ACMobile
//
//  Created by Alex Liao.
//  Copyright © 2018 Alex Liao. All rights reserved.
//  AC Mobile "Eyelid Rejuvenation" VC - nonsurg proc
//

import UIKit
import WebKit

class EyelidRejuvenationVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://appearancecenterapp.com/eyelid-rejuvenation")
