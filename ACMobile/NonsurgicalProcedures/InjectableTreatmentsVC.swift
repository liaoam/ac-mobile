//
//  InjectableTreatmentsVC.swift
//  ACMobile
//
//  Created by Alex Liao.
//  Copyright © 2018 Alex Liao. All rights reserved.
//  AC Mobile "Injectable Treatments" VC - nonsurg proc
//

import UIKit
import WebKit

class InjectableTreatmentsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://appearancecenterapp.com/injectable-treatments")
