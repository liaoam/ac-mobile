...
//  AC Mobile "SkinMedica" VC - partner website
//

import UIKit
import WebKit

class SkinMedicaVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://appearancecenter.brilliantconnections.com/home?lang=en_US")
