//
//  CorrectiveSurgicalVC.swift
//  ACMobile
//
//  Created by Alex Liao.
//  Copyright © 2018 Alex Liao. All rights reserved.
//  AC Mobile "Corrective Surgical Procedures" - surg proc
//

import UIKit
import WebKit

class CorrectiveSurgicalVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://appearancecenterapp.com/corrective-surgical-procedures")
